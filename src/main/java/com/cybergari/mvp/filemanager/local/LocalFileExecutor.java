...
import com.cybergari.mvp.file.FileStructureMetadata;
...
;import static com.cybergari.mvp.filemanager.local.LocalFileMetaDataManager.METADATA_FILE_NAME;
...
public class LocalFileExecutor {
    ...
    public Collection<com.cybergari.mvp.file.File> getAllFilesMetadata() {
    ...
    private com.cybergari.mvp.file.File fileMetadataToFileDomain(final File f) throws IOException {
        ...
        return new com.cybergari.mvp.file.File(
                fileId,
                getFileName(f),
                att.size(),
    ...
    public void persistMetadata(final Collection<com.cybergari.mvp.file.File> toUpdate) {
